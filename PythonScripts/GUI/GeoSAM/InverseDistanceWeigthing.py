...
class InverseDistanceWeighting():
    def __init__(self, inputFname, gridFname):
        self.dataFname = os.path.join(dataDir, inputFname+'.csv')
        outFile = 'Lat_Lon_Grid_'+inputFname[4:]+'.csv'
        self.outFname = os.path.join(resultsDir,outFile)
