...
class Frame3(ttk.Frame, MainApplication):
    def __init__(self, container, fName):
        ...
        self.fishSelect = SubFrameElement(self, fishingFrame, 'Fishing Select', self.fishStr, 1, 0, 1)
        ...
        ilfFrame = ttk.LabelFrame(self, text='Increasing Logistic Function', style='Frame3.TFrame')
        ...
        self.maLength0  = SubFrameElement(self, incidentalFrame, 'MA Length_0',  self.maLen0Str,  0, 2, 3)
        self.gbLength0  = SubFrameElement(self, incidentalFrame, 'GB Length_0',  self.gbLen0Str,  1, 2, 3)
