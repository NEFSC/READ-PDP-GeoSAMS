...
surveydata=read.csv(file="A:/GeoSAMS/GAM/X_Y_BIOM_AL2022_GB.csv") #read in survey data
predictgrid=read.csv(file="A:/GeoSAMS/GAM/GBxyzLatLonRgn.csv",header=FALSE) #read in grid data
...
write.csv(surveydata,file="A:/GeoSAMS/GAM/X_Y_BIOM_AL2022_GB_GAM.csv",row.names=FALSE) #output for survey data
write.csv(predictgrid,file="A:/GeoSAMS/GAM/GBxyzLatLonRgn_GAM.csv",row.names=FALSE) #output for grids
#write.csv(surveydata,file="A:/GeoSAMS/GAM/X_Y_BIOM_AL2022_MA_GAM.csv",row.names=FALSE) #output for survey data
#write.csv(predictgrid,file="A:/GeoSAMS/GAM/MAxyzLatLonRgn_GAM.csv",row.names=FALSE) #output for grids
