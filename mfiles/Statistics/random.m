...
%    ["beta"     , "Beta"],                      @betarnd,      2, ... %  randg is not supported
%    ["chi2"     , "Chi-squared"],               @chi2rnd,      1, ... %  randg is not supported
%    ["f"        , "F-Distribution"],            @frnd,         2, ... %  randg is not supported
%    ["gam"      , "Gamma"],                     @gamrnd,       2, ... %  randg is not supported
%    ["nbin"     , "Negative Binomial"],         @nbinrnd,      2, ... %  randg is not supported
%    ["ncf"      , "Noncentral F-Distribution"], @ncfrnd,       3, ... %  randg is not supported
%    ["nct"      , "Noncentral Student T"],      @nctrnd,       2, ... %  randg is not supported
%    ["ncx2"     , "Noncentral Chi-squared"],    @ncx2rnd,      2, ... %  randg is not supported
%    ["t"        , "Student T"],                 @trnd,         1, ... %  randg is not supported
